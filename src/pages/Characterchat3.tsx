...
import {IonSpinner} from '@ionic/react';
  ...
  const CharacterChatPage3: React.FC = () => {
...
>
  ...
  {isLoading && (
   ...
   <div className="popup-modal-html active" id="popupModal" dangerouslySetInnerHTML={{ __html: htmlContent }}>
        </div>
        </div>
  ...
  export default CharacterChatPage3; 