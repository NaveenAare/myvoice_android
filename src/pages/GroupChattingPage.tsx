import {
  ...
  const scrollToBottomFromSendMessage = () => {
    ...
    const sendMessage = async () => {
      ...
      try {
          const response = await fetch('https://speakingcharacter.ai/send_group_message', {
              method: 'POST',
              headers: {
  ...
  const hardReloadMessages = async () => {
    ...
    try {
        ...
        const fcm = localStorage.getItem('fcmToken');
            ...
            const response = await fetch(`https://speakingcharacter.ai/get_group_messages?authToken=${authToken}&charId=${id}`, {
              method: "GET",
              headers: {
                  "device": "ios",
                  "nottoken": `${fcm}`
  ...
  const deleteCharacter = async () => {
    ...
    if (confirmDeleteButton && loadingSpinner) {
      ...
      try {
        ...
        const response = await fetch('https://speakingcharacter.ai/delete/group/chat', {
          method: 'POST',
          body: formData,
        });
  ...
  export default GroupChattingPage; 