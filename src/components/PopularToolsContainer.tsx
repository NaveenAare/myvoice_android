...
import './PopularTools.css'; // Import CSS styles
...
const SpecialSectionContainer: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const movingCardsWrapper = document.querySelector('.moving-cards-wrapper-your-char-tool') as HTMLElement;
        ...
        dataFull.data.forEach((character: any) => {
          ...
          cardDiv.addEventListener('click', () => {
            router.push(`/character-chat-3/${character.code}`, 'forward', 'push');
  ...
  return (
      ...
      <div className="moving-section-your-char-tool">
        ...
        <div className="moving-cards-wrapper-your-char-tool">
