...
import './SpecialSectionContainer.css'; // Import CSS styles


const SpecialSectionContainer: React.FC = () => {
  const emojis: string[] = ["Love & Relationships 💖"]; // Emoji list
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const movingCardsWrapper = document.querySelector('.moving-cards-wrapper-your-char-love') as HTMLElement;
  ...
  return (
      ...
      <div className="moving-section-your-char-love">
        <h2 id="emoji-head">❤️ Special Section 💎</h2>
        <div className="moving-cards-wrapper-your-char-love">
