  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const movingCardsWrapper = document.querySelector('.moving-cards-wrapper-your-char') as HTMLElement;
  ...
  return (
    <div className="emoji-filter-wrapper">
      ...
      <div className="moving-section-your-char">
        ...
        <div className="moving-cards-wrapper-your-char">
          {/* Skeleton card elements will be displayed here initially */}
          <div className="moving-card">
            <img className="card-image" src="shrimmer.png" alt="Loading..." />
